...
extern int glo_fMapped; // this is bad!
...
***********************************************************************/
Abc_Des_t * Ver_ParseFileExt( char * pFileName, Abc_Des_t * pGateLib, int fCheck, int fUseMemMan )
{
    Ver_Man_t * p;
    Abc_Des_t * pDesign;
    // start the parser
...
***********************************************************************/
extern int Ver_ParseConvertNetwork( Ver_Man_t * pMan, Abc_Ntk_t * pNtk, int fMapped );/*
{
    if ( fMapped )
    {
...
***********************************************************************/
extern int Ver_ParseLookupSuffix( Ver_Man_t * pMan, char * pWord, int * pnMsb, int * pnLsb );/*
{
    unsigned Value;
    *pnMsb = *pnLsb = -1;
...
***********************************************************************/
extern int Ver_ParseInsertsSuffix( Ver_Man_t * pMan, char * pWord, int nMsb, int nLsb );/*
{
    unsigned Value;
    if ( pMan->tName2Suffix == NULL )
...
***********************************************************************/
extern int Ver_ParseSignalPrefix( Ver_Man_t * pMan, char ** ppWord, int * pnMsb, int * pnLsb );/*
{
...
***********************************************************************/
extern int Ver_ParseSignalSuffix( Ver_Man_t * pMan, char * pWord, int * pnMsb, int * pnLsb );/*
{
    char * pCur;
    int Length;
    Length = strlen(pWord);
...
***********************************************************************/
extern int Ver_ParseConstant( Ver_Man_t * pMan, char * pWord );/*
{
    int nBits, i;
...
***********************************************************************/
extern int Ver_FindGateInput( Mio_Gate_t * pGate, char * pName );/*
{
    Mio_Pin_t * pGatePin;
    int i;
...
***********************************************************************/
extern int Ver_ParseConnectDefBoxes( Ver_Man_t * pMan );
...
***********************************************************************/
extern int Ver_ParseCheckNondrivenNets( Vec_Ptr_t * vUndefs );
...
***********************************************************************/
extern int Ver_ParseFormalNetsAreDriven( Abc_Ntk_t * pNtk, char * pNameFormal );/*
{
...
***********************************************************************/
extern int Ver_ParseDriveFormal( Ver_Man_t * pMan, Abc_Ntk_t * pNtk, Ver_Bundle_t * pBundle0 );
...
***********************************************************************/
extern int Ver_ParseDriveInputs( Ver_Man_t * pMan, Vec_Ptr_t * vUndefs );
...
***********************************************************************/
extern int Ver_ParseMaxBoxSize( Vec_Ptr_t * vUndefs );/*
{
    Abc_Ntk_t * pNtk;
    Abc_Obj_t * pBox;
    int i, k, nMaxSize = 0;
